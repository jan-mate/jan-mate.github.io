...
const spaceLinksCheckbox = document.getElementById('spaceLinks'); // New "Space Links" option
const copyButton = document.getElementById('copy');
const spacesInput = document.getElementById('spaces');
const newlinesInput = document.getElementById('newlines');
